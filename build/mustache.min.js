...
1;return{position:function(b){b=+b;isFinite(b)&&(a.value=b);return+a},K:function(e){var c=a.value,d=b,f,g=[];b=1;a.value=0;for(f=this.next(e);f;)g.push(f),f=this.next(e);b=d;a.value=c;return g},next:function(o){o||(o={left:"{{",right:"}}"});var l="",k="",h=-1,i=q,j=q,t=o.left,p=t.length,o=o.right,u=o.length;0<a&&(a.value-=1);for(;c();)if("\n"===e?"\r"!==d.charAt(a-1)&&(b+=1):"\r"===e&&(b+=1),d.substr(+a,p)===t){h=+a;c(p);switch(e){case "=":case "!":case "&":case "~":case "{":case "#":case "^":case "/":case ">":case "@":k=
e;break;case ".":k=l=e;break;default:l+=e}for(;c();)if(!("{"===k&&"}}"===o&&"}}}"===d.substr(+a,3)))if(d.substr(+a,u)===o){c(u);break}else l+=e;"="===k&&(l=l.substring(0,l.length-1));if("."===k&&l!==k)l=k="";else if(i=g[k]){j={type:i,value:r.trim(l),text:d.substring(h,+a),start:m(h),end:m(+a),i:b};break}else l=k=""}else{for(h=+a;e&&d.substr(+a,p)!==t;)c();j={type:"text",value:d.substring(h,a),text:d.substring(h,a),start:m(h),end:m(+a),i:b};if(j.text)break;else j=q}return j}}}var g={"!":"comment",
...
typeof e&&(e=e()),a=s(e));e=b[d-1];e=a.get(e);e===n?e="":e&&"function"===typeof e.valueOf&&e.valueOf!==g?e=e.valueOf():"function"===typeof e&&(e=e());return e},q:function(a){function e(a,b){return d.e({c:a,data:b||i,d:k,b:h,a:f})}for(var b=a.name,c=a.r,f=a.a,k=a.d,h=a.b,i=f.g(),a=b.split("."),j=0,m=a.length,p=f,c=c.toString(),j=0;j<m-1;j+=1)b=a[j],b=p.get(b),b===n?(b="",j=m):(b&&"function"===typeof b.valueOf&&b.valueOf!==g?b=b.valueOf():"function"===typeof b&&(b=1<=b.t.length?b(c,e):b()),p=s(b));
b=a[m-1];b=p.get(b);b===n?b="":b&&"function"===typeof b.valueOf&&b.valueOf!==g?b=b.valueOf():"function"===typeof b&&(b=b(c,e));return b},o:function(a){function e(a,b){return d.e({c:a,data:b||i,d:k,b:h,a:f})}for(var b=a.name,c=a.r,f=a.a,k=a.d,h=a.b,i=f.g(),a=b.split("."),j=0,m=a.length,p=f,c=c.toString(),j=0;j<m-1;j+=1)b=a[j],b=p.get(b),b===n?(b="",j=m):(b&&"function"===typeof b.valueOf&&b.valueOf!==g?b=b.valueOf():"function"===typeof b&&(b=1<=b.t.length?b(c,e):b()),p=s(b));b=a[m-1];b=p.get(b);b===
...
end:c.end.value,j:b||""})},v:function(a,e,b){c.l(a,e);a.replace({f:e.start.value,end:e.end.value,j:b||""})},u:function(a){var c=a.c,b=a.data,f=a.d,l=a.a,a=a.b,k=0,h=0,i="",j=q,m=!1;r.isArray(b)||(b=b?[b]:[]);h=b.length;for(k=0;k<h;k+=1)j=b[k],m=!1,l.push(j),j&&"function"===typeof j.valueOf&&j.valueOf!==g&&(m=!0,j=j.valueOf(),l.push(j)),"function"===typeof j&&(m=!0,j=j(),l.push(j)),j=d.e({c:"="+c+"=",data:j,a:l,b:a,d:f}),i+=j.substring(1,j.length-1),l.pop(),m&&l.pop();return i}},m={C:function(a){var e=
...
a=a.b,k="",h=c.l(e,b),i=a[b.value];i&&(i=i.toString(),h&&(i=r.D(i,h)),k=d.e({c:i,data:f,a:g,b:a}));c.k(e,b,k)},q:function(a){var e=a.c,b=a.h,g=a.a,l=a.b,a=a.d,k=b.n,h=q,i=q;c.l(e,k);c.l(e,b);h=e.substring(b.start+b.text.length,k.end-k.text.length);i=f.q({name:b.value,r:h,a:g,d:a,b:l});"string"===typeof i?(i=d.e({c:i,data:g.g(),a:g,d:a,b:l}),e.replace({f:b.start,end:k.end,j:i})):!i||r.isArray(i)&&!i.length?e.replace({f:b.start,end:k.end}):e.replace({f:b.start,end:k.end,j:c.u({c:h,data:i,a:g,b:l,d:a})})},
o:function(a){var e=a.c,b=a.h,d=a.a,g=a.b,a=a.d,k=b.n,h=q,i=q;c.l(e,k);c.l(e,b);h=e.substring(b.start+b.text.length,k.end-k.text.length);i=f.o({name:b.value,r:h,d:a,b:g,a:d});i=!i||r.isArray(i)&&!i.length?!0:!1;!i||r.isArray(i)&&!i.length?e.replace({f:b.start,end:k.end}):e.replace({f:b.start,end:k.end,j:c.u({c:h,data:i,a:d,b:g,d:a})})}};d={e:function(a){var e=y(a.c?a.c.toString():""),b=a.b||{},d=a.data||{},f=w(e),g=a.d||{left:"{{",right:"}}"},a=a.a||s(),h=q,b={c:e,data:d,a:a,b:b,d:g};a.push(d);for(h=
f.next(g);h;){b.h=h;switch(h.type){case "implicit":m.C(b);break;case "comment":c.v(e,h);break;case "set-delimiter":m.G(b);break;case "interpolation":m.m(b);break;case "unescape-interpolation":m.H(b);break;case "partial":m.F(b);break;case "section-begin":m.q(b);break;case "invert-section-begin":m.o(b);break;case "text":break;default:throw Error('Unexpected token: "'+h.text+'" on line '+h.i);}h=f.next(g)}if(f.A())throw h=f.z(),Error('Missing section-end for : "'+h.text+'" on line '+h.i);a.pop();return e.toString()}};
